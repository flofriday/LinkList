defmodule LinklistWeb.LinkLiveTest do
  use LinklistWeb.ConnCase

  import Phoenix.LiveViewTest
  import Linklist.LinksViewFixtures

  @create_attrs %{description: "some description", image_url: "some image_url", title: "some title", url: "some url"}
